...
const Color COLOR_NODO_NO_VIS     = { 70,  80, 110, 255};
...
const Color COLOR_NODO_PROCESANDO = {255, 155,  40, 255};
...
const Color COLOR_TEXTO_NODO      = {255, 255, 255, 255};
...
const Color COLOR_ARBOL_TEXTO_PISTA = {210, 215, 235, 255};
